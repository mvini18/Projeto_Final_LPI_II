...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first"><br>
      ...
      <form action="../novoUsuario" onsubmit="return validatePassword()" name="registro" method="post">
	      ...
	      <input type="text" title="Cpf" id="cpf" class="fadeIn fourth cpf-mask" name="txtCpf" placeholder="cpf" minlength="11" maxlength="11" pattern="^[0-9]{3}.?[0-9]{3}.?[0-9]{3}-?[0-9]{2}" autocomplete="off" required>
	      ...
	      <input type="password" id="senha" title="Senha" id="senha" class="fadeIn six" name="txtSenha" data-minlength="8" placeholder="senha" minlength="6" maxlength="20" autocomplete="off" size="15">
	      <input type="password" id="confirmar_senha" title="Confirmar senha" id="confirmarsenha" class="fadeIn six" data-minlength="8" name="txtConfirmarSenha" placeholder="confirmar" maxlength="20" autocomplete="off">
