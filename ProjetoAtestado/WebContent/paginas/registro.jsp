...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first"><br>
      ...
      <form action="../novoUsuario" onsubmit= "return validarSenha()" method="post">
	      ...
	      <input type="tel" title="Telefone" id="telefone" class="fadeIn five" name="txtTelefone" placeholder="(99) 99999-9999" maxlength="15" autocomplete="off" pattern="(\([0-9]{2}\))\s([9]{1})?([0-9]{4})-([0-9]{4})" required>
	      ...
	      <input type="password" id="confirmar_senha" title="Confirmar senha" class="fadeIn six" data-minlength="8" name="txtConfirmarSenha" placeholder="confirmar" maxlength="20" autocomplete="off" required>
