	...
	<div id="formContent">
		...
		<form method="post" action="../segundoAtestado">
			<p class="fadeIn third">Escreva abaixo o que você está sentindo,
				...
				informe o nome da pessoa acompanhada e o número da identidade dela.</p>
			...
			<textarea required title="Informações" maxlength="500" placeholder="Exemplo: Dor forte como uma faixa apertando a cabeça." class="fadeIn five" id="sintomas" name="txtSintomas" rows="2" cols="33"></textarea>
			<input type="submit"
