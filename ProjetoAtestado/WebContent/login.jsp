...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form>
      ...
      <input type="submit" class="btn btn-primary js-scroll-trigger" value="Entrar">
      <a href="registro.jsp"><input type="button" class="btn btn-primary js-scroll-trigger" value="Registrar"></a>
    </form>
